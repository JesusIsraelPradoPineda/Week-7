...
int main(void) {
  ...
  scanf("%d",&x1); //I recive the menu option that you have chossen
  if (x1 == 1) //if this is 1, you'll get in the miles section
  {
    printf("give me the miles\n"); //I ask the miles
    scanf("%f",&K); //I scan in the variable K the miles
